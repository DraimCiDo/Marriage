...
public class DatabaseListener implements Listener {
    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        ...
        core.getLogger().log(Level.WARNING, "Игрока " + event.getPlayer().getName() + " не было в кэше, и он будет загружен в основной поток.");
        core.getLogger().log(Level.INFO, "Если это сообщение появляется часто, сообщите разработчику");
